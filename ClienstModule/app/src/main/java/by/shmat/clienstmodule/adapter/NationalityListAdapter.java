...
public class NationalityListAdapter extends RecyclerView.Adapter<NationalityListAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder viewHolder, int position) {
        ...
        viewHolder.nameView.setText(nationality.getName());
        viewHolder.parentView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.putExtra("nationalityName", nationalityList.get(viewHolder.getAdapterPosition()).getName());
